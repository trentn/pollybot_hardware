...
#define MOTOR_MAX_RPM 76                   // motor's max RPM          
...
#define COUNTS_PER_REV1 8384              // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 8384              // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 8384              // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 8384              // wheel4 encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.090                // wheel's diameter in meters
#define LR_WHEELS_DISTANCE 0.3683            // distance between left and right wheels
